...
Non viene garantità ne l'integrità (messaggio intercettato da terzi e riutilizzato da quest'ultimi) ne l'autenticazione (non vi è sicureza sull'identità del mittente).
